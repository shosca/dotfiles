...
lspconfig.rust_analyzer.setup({ on_attach = lsp.common_on_attach, capabilities = lsp.capabilities })
...
lspconfig.kotlin_language_server.setup({ on_attach = lsp.on_attach, capabilities = lsp.capabilities })
