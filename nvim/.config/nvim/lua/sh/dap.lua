...
function M.configure_packer(use)
  use {
    ...
    config = function()
      ...
      nmap {"<leader>B", function() dap.set_breakpoint(vim.fn.input('Breakpoint condition: ')) end, {silent = true}}
      nmap {"<leader>lp", function() dap.set_breakpoint(nil, nil, vim.fn.input('Log point message: ')) end, {silent = true}}
