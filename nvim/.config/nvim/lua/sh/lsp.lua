...
function M.on_attach_lsp_keymaps(_, bufnr)
  ...
  nmap({ "lD", vim.lsp.buf.declaration, { silent = true, buffer = bufnr } })
  nmap({ "ld", vim.lsp.buf.definition, { silent = true, buffer = bufnr } })
  nmap({ "li", vim.lsp.buf.implementation, { silent = true, buffer = bufnr } })
  nmap({ "lf", vim.lsp.buf.format, { silent = true, buffer = bufnr } })
  nmap({ "lr", vim.lsp.buf.references, { silent = true, buffer = bufnr } })
  nmap({ "ll", vim.lsp.buf.hover, { silent = true, buffer = bufnr } })
  nmap({ "lk", vim.lsp.buf.signature_help, { silent = true, buffer = bufnr } })
  nmap({ "la", vim.lsp.buf.code_action, { silent = true, buffer = bufnr } })
